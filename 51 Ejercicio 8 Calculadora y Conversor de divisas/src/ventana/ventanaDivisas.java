...
public class ventanaDivisas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboDivisas1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Estados Unidos - Dolar", "Perú - Nuevo Sol", "Europa - Euro", " " }));
        ...
        comboDivisas2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Estados Unidos - Dolar", "Perú - Nuevo Sol", "Europa - Euro", " " }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaDivisas.class
