...
public class Ventana extends JFrame {
    ...
    private void colocarListas() {
        ...
        modelo.addElement(new Persona("German Balagueraaaaaaaaaaaaaaaaaaaaaaaaaa",32,"Colombiano"));
        modelo.addElement(new Persona("Stefany Davila",20,"Mexicano"));
        modelo.addElement(new Persona("German Balaguera",32,"Colombiano"));
        modelo.addElement(new Persona("Stefany Davila",20,"Mexicano"));
        modelo.addElement(new Persona("German Balaguera",32,"Colombiano"));
        modelo.addElement(new Persona("Stefany Davila",20,"Mexicano"));
        modelo.addElement(new Persona("German Balaguera",32,"Colombiano"));
