...
public class Ventana extends JFrame {
    ...
    private void iniciarComponentes() {
        ...
        etiqueta.setBounds(10, 10, 250, 50);//Establece el tamaño y la posicion de la etiqueta en un solo comando.
        ...
        etiqueta.setFont(new Font("Time New Roman", Font.ITALIC,20));//Establecer la fuente del texto
